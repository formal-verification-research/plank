...
DV = 3.6 * 10**-5  # VEGF Diffusion Coefficient (mm^2/h)
...
V1 = 0.007692308  # Kinetic Parameters for VEGF (1/uM)
...
V0 = 0.04  # VEGF Source Term Constants (uM*mm^2/h)
...
RELAX1 = 1.45  # Over-relaxation Variable Used For VEGF Iteration (Unit-less)
